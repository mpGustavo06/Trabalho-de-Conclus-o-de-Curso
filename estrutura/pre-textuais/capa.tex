...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{Sistema de Notificação Automatizada para Criadores de Conteúdo com Integração Multicanal}
\autor{Gustavo Matheus Pauvels}
\autorcitacao{PAUVELS, Gustavo Matheus} % Sobrenome em maiúsculo
\local{Toledo}
\data{2025}
...
\instOrientador{}
\coorientador{prof. Ms. Eduardo Pezutti Beletato dos Santos}
